...
//     print(Provider.of<CoinData>(context).coinList.toString());
//     return MultiProvider(
//       providers: [
//         // FutureProvider(
//         //     create: (ctx) =>
//         //         Provider.of<UserProvider>(context).getExchangeData(),
//         //     catchError: (context, error) => print(error.toString()),
//         //     initialData: 'Getting Exchange Data'),
//         // FutureProvider(
//         //     create: (ctx) => Provider.of<CoinData>(context).getCoinData(),
//         //     catchError: (context, error) => print(error.toString()),
//         //     initialData: 'Getting coin data...'),
//         FutureProvider(
//             create: (ctx) =>
//                 Provider.of<UserProvider>(context).updateCoinData(context),
//             catchError: (context, error) => print(error.toString()),
//             initialData: 'Updating coin data...'),
//         FutureProvider(
//             create: (ctx) =>
//                 Provider.of<UserProvider>(context).getPortfolioValue(),
//             catchError: (context, error) => print(error.toString()),
//             initialData: 'Calculating prorfolio value...'),
//       ],
//       child: Scaffold(
...
//                                       },
//                                       child: Text(
//                                         num.parse(user.user.porfolioValue
//                                                 .toString())
//                                             .toStringAsFixed(2),
...
//                                   itemCount:
//                                       user.user.supportedCurrencies.length,
//                                   itemBuilder:
